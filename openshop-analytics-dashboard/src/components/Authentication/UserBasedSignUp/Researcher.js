  ...
  const ResearcherSignUp = () => {
      ...
      try {
        const response = await fetch("http://localhost:5000/api/user/researcher", {
          ...
          body: JSON.stringify({
            ...
            userType: "researcher",
            // researchField: credentials.researchField,
    ...
    return (
      <Stack spacing="6">
        ...
        <Stack spacing="5">
          <FormControl isRequired id="researchField">
            <FormLabel htmlFor="researchField" color="white">
              Research Field
            </FormLabel>
            <Input
              background="white"
              type="text"
              name="researchField"
              value={credentials.researchField}
